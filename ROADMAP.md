...
- add example private/exported note outputs;
- improve privacy and failure vocabulary;
- add contract tests around export boundaries;
- prepare the first alpha-quality local note workflow proof.
